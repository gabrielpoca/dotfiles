return {
  {
    ...
    keys = {
      ...
      { "<leader>bl", ":BufferNext<CR>", desc = "Next" },
      { "<leader>bh", ":BufferPrevious<CR>", desc = "Previous" },
      { "<leader>bd", ":BufferCloseAllButCurrentOrPinned<CR>", desc = "Close other buffers" },
      { "<leader>bb", ":BufferOrderByBufferNumber<CR>", desc = "Order by number" },
      { "<leader>bo", ":BufferPick<CR>", desc = "Pick buffer" },
      { "<leader>bp", ":BufferPin<CR>", desc = "Pin/unpin buffer" },
    },
  },
  {
