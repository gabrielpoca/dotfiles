...
export declare class CocSnippet {
    ...
    insertSnippet(placeholder: CocSnippetPlaceholder, snippet: string, position: Position): number;
    updatePlaceholder(placeholder: CocSnippetPlaceholder, edit: TextEdit): TextEdit[];
    private update;
}
