...
const commands_1 = __importDefault(require("./source/commands"));
const diagnostics_1 = __importDefault(require("./source/diagnostics"));
const extensions_2 = __importDefault(require("./source/extensions"));
const links_1 = __importDefault(require("./source/links"));
const lists_1 = __importDefault(require("./source/lists"));
const location_1 = __importDefault(require("./source/location"));
const outline_1 = __importDefault(require("./source/outline"));
const output_1 = __importDefault(require("./source/output"));
const services_1 = __importDefault(require("./source/services"));
const sources_1 = __importDefault(require("./source/sources"));
const symbols_1 = __importDefault(require("./source/symbols"));
...
class ListManager {
    ...
    init(nvim) {
        this.nvim = nvim;
        this.config = workspace_1.default.getConfiguration('list');
    ...
    async start(args) {
        ...
        try {
            ...
            this.currList = list;
            if (!list.interactive)
                this.listOptions.interactive = false;
            ...
            setTimeout(async () => {
                let line = await this.nvim.call('coc#util#echo_line');
    ...
    async onInsertInput(ch, charmod) {
        ...
        if (done || charmod || charMap.has(ch))
            return;
        for (let s of ch) {
