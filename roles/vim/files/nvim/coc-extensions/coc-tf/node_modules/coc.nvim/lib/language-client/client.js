...
const Is = __importStar(require("../util/is"));
const workspace_1 = __importDefault(require("../workspace"));
const async_1 = require("./utils/async");
const cv = __importStar(require("./utils/converter"));
...
class BaseLanguageClient {
    ...
    initialize(connection) {
        ...
        let rootPath = workspace_1.default.rootPath;
        if (this._clientOptions.workspaceFolder) {
            rootPath = vscode_uri_1.default.parse(this._clientOptions.workspaceFolder.uri).fsPath;
        }
        else {
            ...
            if (rootPatterns && rootPatterns.length) {
                ...
                if (doc && doc.schema == 'file') {
                    let dir = path_1.default.dirname(vscode_uri_1.default.parse(doc.uri).fsPath);
                    resolved = fs_1.resolveRoot(dir, rootPatterns);
                }
            }
            if (resolved)
                rootPath = resolved;
        ...
        let initParams = {
            ...
            rootUri: rootPath ? cv.asUri(vscode_uri_1.default.file(rootPath)) : null,
