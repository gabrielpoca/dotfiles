...
export declare type BufEvents = 'TextChangedI' | 'BufHidden' | 'BufEnter' | 'TextChanged' | 'BufWritePost' | 'CursorHold' | 'InsertLeave' | 'BufCreate' | 'BufUnload' | 'BufWritePre' | 'CursorHoldI' | 'TextChangedP' | 'Enter';
export declare type EmptyEvents = 'InsertEnter' | 'FocusGained';
export declare type AllEvents = BufEvents | EmptyEvents | MoveEvents | 'CompleteDone' | 'MenuPopupChanged' | 'InsertCharPre' | 'FileType' | 'BufWinEnter' | 'BufWinLeave' | 'VimResized' | 'DirChanged' | 'OptionSet' | 'Command' | 'BufReadCmd' | 'GlobalChange' | 'InputChar';
