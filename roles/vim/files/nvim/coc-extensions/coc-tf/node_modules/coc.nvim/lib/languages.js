...
const codeActionmanager_1 = __importDefault(require("./provider/codeActionmanager"));
const codeLensManager_1 = __importDefault(require("./provider/codeLensManager"));
const declarationManager_1 = __importDefault(require("./provider/declarationManager"));
const definitionManager_1 = __importDefault(require("./provider/definitionManager"));
const documentColorManager_1 = __importDefault(require("./provider/documentColorManager"));
const documentHighlightManager_1 = __importDefault(require("./provider/documentHighlightManager"));
const documentLinkManager_1 = __importDefault(require("./provider/documentLinkManager"));
const documentSymbolManager_1 = __importDefault(require("./provider/documentSymbolManager"));
const foldingRangeManager_1 = __importDefault(require("./provider/foldingRangeManager"));
const formatManager_1 = __importDefault(require("./provider/formatManager"));
const formatRangeManager_1 = __importDefault(require("./provider/formatRangeManager"));
const hoverManager_1 = __importDefault(require("./provider/hoverManager"));
const implementatioinManager_1 = __importDefault(require("./provider/implementatioinManager"));
const onTypeFormatManager_1 = __importDefault(require("./provider/onTypeFormatManager"));
const referenceManager_1 = __importDefault(require("./provider/referenceManager"));
const renameManager_1 = __importDefault(require("./provider/renameManager"));
const signatureManager_1 = __importDefault(require("./provider/signatureManager"));
const typeDefinitionManager_1 = __importDefault(require("./provider/typeDefinitionManager"));
const workspaceSymbolsManager_1 = __importDefault(require("./provider/workspaceSymbolsManager"));
const manager_2 = __importDefault(require("./snippets/manager"));
const sources_1 = __importDefault(require("./sources"));
const types_1 = require("./types");
const util_1 = require("./util");
const complete = __importStar(require("./util/complete"));
...
class Languages {
    ...
    async provideDocumentFormattingEdits(document, options) {
        if (!this.formatManager.hasProvider(document)) {
            workspace_1.default.showMessage('Format provider not found for current document', 'error');
            return null;
        }
    ...
    async provideDocumentRangeFormattingEdits(document, range, options) {
        if (!this.formatRangeManager.hasProvider(document)) {
            workspace_1.default.showMessage('Range format provider not found for current document', 'error');
            return null;
        }
