...
import { Event, Position, Range, TextDocumentContentChangeEvent } from 'vscode-languageserver-protocol';
...
export declare class SnippetSession {
    ...
    start(snippetString: string, select?: boolean, position?: Position): Promise<boolean>;
    private activate;
    deactivate(): void;
